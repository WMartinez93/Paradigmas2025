...
interseccion(C_25_de_Mayo, Av_Francia, 2, 0).
interseccion(C_25_de_Mayo, Antequera, 2, 1).
interseccion(C_25_de_Mayo, Artigas, 2, 2).
interseccion(C_25_de_Mayo, J_L_Mallorquin, 2, 3).
interseccion(C_25_de_Mayo, Mcal_Estigarribia, 2, 4).
interseccion(C_25_de_Mayo, C_A_Lopez, 2, 5).
interseccion(C_25_de_Mayo, Lomas_Valentinas, 2, 6).
interseccion(C_25_de_Mayo, Independencia_Nacional, 2, 7).
interseccion(C_25_de_Mayo, Honorio_Gonzalez, 2, 8).
interseccion(C_25_de_Mayo, Av_Irrazabal, 2, 9).
...
interseccion(C_14_de_Mayo, Av_Francia, 5, 0).
interseccion(C_14_de_Mayo, Antequera, 5, 1).
interseccion(C_14_de_Mayo, Artigas, 5, 2).
interseccion(C_14_de_Mayo, J_L_Mallorquin, 5, 3).
interseccion(C_14_de_Mayo, Mcal_Estigarribia, 5, 4).
interseccion(C_14_de_Mayo, C_A_Lopez, 5, 5).
interseccion(C_14_de_Mayo, Lomas_Valentinas, 5, 6).
interseccion(C_14_de_Mayo, Independencia_Nacional, 5, 7).
interseccion(C_14_de_Mayo, Honorio_Gonzalez, 5, 8).
interseccion(C_14_de_Mayo, Av_Irrazabal, 5, 9).
